    ...
    return (
        <>
            <section class="sobre-projeto">
                <h2 class="display-5 text-center titulo-secao">🧮 Sobre o Projeto</h2>
            ...
            <section class="sobre-desenvolvedor">
                <h2 class="display-5 text-center titulo-secao">👨‍💻 Sobre o Desenvolvedor</h2>
                <p class="descricao-desenvolvedor">
